...
export const aboutText = `Gerald Baalham is a dedicated full-stack web developer with a deep passion for building
  ...
  solutions, Gerald takes a meticulous approach to every project he undertakes. He has a
  ...
  navigation, ensuring a flawless experience across all devices and screen sizes. Gerald's
  ...
  handling complex projects from start to finish. Beyond his technical skills, Gerald is
  ...
  Gerald, web development is more than just writing code—it's about creating meaningful
